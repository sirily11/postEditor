...
import {insertAudioBlock, insertImageBlock} from "./utils/insertImageBlock";
import {computeDownloadProgress, computeUploadProgress, deleteImage} from "./utils/uploadUtils";
//@ts-ignore
...
export class MainEditorProvider extends React.Component<MainEditorProps,
    MainEditorState> {
