...
export function UploadField() {
    ...
    return <Segment style={{width: "100%", margin: "10px", marginTop: "30px"}}>
        <form className={classes.root} noValidate autoComplete="off">
            <TextField value={access_id} id="outlined-basic" label="Access ID" variant="outlined"
                       onChange={(e) => setAccess(e.target.value)}/>
            <TextField value={secret_id} id="outlined-basic" label="Secret ID" variant="outlined"
                       onChange={(e) => setSecret(e.target.value)}/>
            <TextField value={bucket} id="outlined-basic" label="Bucket Name" variant="outlined"
